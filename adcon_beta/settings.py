...
INSTALLED_APPS = [
    ...
    # Framework de API y Autenticación JWT
    'rest_framework',
...
# ─────────────────────────────────────────────────────────────────────────────
# Configuración de SimpleJWT — Seguridad de tokens para Adcon
#
# Se definen políticas de expiración y seguridad para el manejo de documentos
# y datos sensibles. Se habilita la rotación de refresh tokens para
# invalidar sesiones anteriores tras cada renovación.
# ─────────────────────────────────────────────────────────────────────────────
...
# NOTA: Se habilita almacenamiento local para verificación en carpeta 'media/'
# previa transición final a S3.
STORAGES = {
    # Archivos estáticos servidos localmente (CSS, JS, imágenes del sistema)
    'staticfiles': {
        'BACKEND': 'django.contrib.staticfiles.storage.StaticFilesStorage',
    },
    # Archivos de medios (contratos, PDFs, documentos legales) → Local (Desarrollo)
    'default': {
        'BACKEND': 'django.core.files.storage.FileSystemStorage',
    },
}

# Configuración de rutas locales para medios
MEDIA_URL = '/media/'
